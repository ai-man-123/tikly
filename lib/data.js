...
function expandUrl(tiktok_url) {
  return new Promise(async function(resolve, reject) { 
   axios.get(tiktok_url, { headers: { "User-agent": "Mozilla/5.0 (Linux; Android 11; RMX3235) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36" }})
    .then((res) => {
